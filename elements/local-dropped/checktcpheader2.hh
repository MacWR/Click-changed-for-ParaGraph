#ifndef CLICK_CHECKTCPHEADER2_HH
#define CLICK_CHECKTCPHEADER2_HH
...
Boolean. If it is true, then CheckTCPHeader2 will maintain detailed counts of
...
Returns the number of incorrect packets CheckTCPHeader2 has seen.

=h drop_details read-only

Returns a text file showing how many erroneous packets CheckTCPHeader2 has
...
class CheckTCPHeader2 : public Element { public:

  CheckTCPHeader2() CLICK_COLD;
  ~CheckTCPHeader2() CLICK_COLD;

  const char *class_name() const		{ return "CheckTCPHeader2"; }
