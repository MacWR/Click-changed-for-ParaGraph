// -*- c-basic-offset: 4 -*-
#ifndef CLICK_THREADSAFEQUEUE2_HH
#define CLICK_THREADSAFEQUEUE2_HH
...
class ThreadSafeQueue2 : public FullNoteQueue { public:

    ThreadSafeQueue2() CLICK_COLD;

    const char *class_name() const		{ return "ThreadSafeQueue2"; }
