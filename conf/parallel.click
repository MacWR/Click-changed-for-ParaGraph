...
//parallel
from@parallel  -> CheckLength(1500) -> SetTimestamp -> Print(in,TIMESTAMP true,CONTENTS NONE) -> adp@parallel -> oc@parallel

oc@parallel[0] -> QuickNoteQueue -> [1]rru0@parallel[1] -> [1]cpb0@parallel
...
cpb2@parallel[1] -> QuickNoteQueue -> SetTimestamp -> Print(out,TIMESTAMP true,CONTENTS NONE) ->CheckPaint2(252,7) -> to@parallel
