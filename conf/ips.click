...
from@ips -> CheckLength(1500)-> SetTimestamp -> Print(in,TIMESTAMP true, CONTENTS NONE) -> EnsureEther -> ee@ips -> c0@ips
...
rrs@ips -> SetTimestamp -> Print(out,TIMESTAMP true, CONTENTS NONE) -> to@ips
