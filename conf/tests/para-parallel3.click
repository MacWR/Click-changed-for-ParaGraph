...
//parallel
from@parallel -> CheckLength(1500) -> ee -> MarkIPHeader(14)-> CheckIPHeader(14) -> AutoDPaint(1000,250) -> SetTimestamp -> Print(in,TIMESTAMP true,CONTENTS NONE)-> c0 
c0[0] -> Discard
c0[2] -> Discard
c0[1] -> oc@parallel

oc@parallel[0] -> ipf@fw
