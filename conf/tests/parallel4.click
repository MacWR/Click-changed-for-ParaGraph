...
c0@ips[0] -> checkarp@ips -> Paint(250,7) -> tsq3@parallel
c0@ips[1] -> checkip@ips -> ipf@ips
c0@ips[2] -> Paint(252,7) -> tsq3@parallel

ipf@ips[0] -> c1@ips 
c1@ips[0] -> checkudp@ips 
checkudp@ips[0] -> check0@ips -> Paint(250,7) -> tsq3@parallel
checkudp@ips[1] -> check2@ips -> setudpchecksum@ips[0] -> Paint(251,7) -> tsq3@parallel
setudpchecksum@ips[1] -> Paint(252,7) -> tsq3@parallel

c1@ips[1] -> checktcp@ips
checktcp@ips[0] -> check1@ips -> Paint(250,7) -> tsq1@parallel
checktcp@ips[1] -> check3@ips -> settcpchecksum@ips -> Paint(251,7) -> tsq3@parallel
...
//ips2
tee@parallel[4] -> ee@ips2-> c0@ips2
c0@ips2[0] -> checkarp@ips2 -> Paint(250,7) -> tsq1@parallel
c0@ips2[1] -> checkip@ips2 -> ipf@ips2
c0@ips2[2] -> Paint(252,7) -> tsq1@parallel

ipf@ips2[0] -> c1@ips2 
c1@ips2[0] -> checkudp@ips2 
checkudp@ips2[0] -> check0@ips2 -> Paint(250,7) -> tsq1@parallel
checkudp@ips2[1] -> check2@ips2 -> setudpchecksum@ips2[0] -> Paint(251,7) -> tsq1@parallel
setudpchecksum@ips2[1] -> Paint(252,7) -> tsq1@parallel

c1@ips2[1] -> checktcp@ips2
checktcp@ips2[0] -> check1@ips2 -> Paint(250,7) -> tsq1@parallel
checktcp@ips2[1] -> check3@ips2 -> settcpchecksum@ips2 -> Paint(251,7) -> tsq1@parallel


c1@ips2[2] -> Paint(252,7) -> tsq1@parallel
ipf@ips2[1] -> Paint(252,7) -> tsq1@parallel
...
cpb3@parallel[1] -> QuickNoteQueue -> SetTimestamp -> Print(out,TIMESTAMP true,CONTENTS NONE) ->CheckPaint2(252,7) -> to@parallel
